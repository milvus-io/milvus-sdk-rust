...
project downloads `milvus-sdk-rust` version `3.0.1` from crates.io and demonstrates every usable
V2 `DataType`.
...
- `milvus-sdk-rust` version `3.0.1` has been published to crates.io.
