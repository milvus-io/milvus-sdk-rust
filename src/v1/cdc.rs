...
pub struct GetReplicateInfoResponse {
    pub checkpoint: Option<ReplicateCheckpoint>,
    pub salvage_checkpoint: Option<ReplicateCheckpoint>,
}
...
impl From<crate::proto::milvus::GetReplicateInfoResponse> for GetReplicateInfoResponse {
    fn from(value: crate::proto::milvus::GetReplicateInfoResponse) -> Self {
        Self {
            checkpoint: value.checkpoint.map(Into::into),
            salvage_checkpoint: value.salvage_checkpoint.map(Into::into),
        }
    }
}
